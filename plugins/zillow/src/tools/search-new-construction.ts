...
export const searchNewConstruction = defineTool({
  ...
  description:
    'Search for new construction properties on Zillow. Requires either a region_id (from search_locations) or map_bounds. Filters to new construction homes including those coming soon.',
