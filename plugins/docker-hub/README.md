# opentabs-plugin-docker-hub

OpenTabs plugin for Docker Hub
...
```json
{
  "name": "opentabs-plugin-docker-hub",
  "main": "dist/adapter.iife.js",
  "opentabs": {
    "displayName": "Docker Hub",
    "description": "OpenTabs plugin for Docker Hub",
    "urlPatterns": ["*://*.hub.docker.com/*"]
  }
}
```
