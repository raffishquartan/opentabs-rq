# opentabs-plugin-homedepot

OpenTabs plugin for The Home Depot
...
```json
{
  "name": "opentabs-plugin-homedepot",
  "main": "dist/adapter.iife.js",
  "opentabs": {
    "displayName": "Home Depot",
    "description": "OpenTabs plugin for The Home Depot",
    "urlPatterns": ["*://*.homedepot.com/*"]
  }
}
```
