# opentabs-plugin-booking

OpenTabs plugin for Booking.com
...
```json
{
  "name": "opentabs-plugin-booking",
  "main": "dist/adapter.iife.js",
  "opentabs": {
    "displayName": "Booking.com",
    "description": "OpenTabs plugin for Booking.com",
    "urlPatterns": ["*://*.www.booking.com/*"]
  }
}
```
