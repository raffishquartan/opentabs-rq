...
vi.mock('./browser-commands/index.js', () => ({
  ...
  handleBrowserInterceptRequests: vi.fn(asyncNoop),
  handleBrowserFulfillRequest: vi.fn(asyncNoop),
  handleBrowserFailRequest: vi.fn(asyncNoop),
  handleBrowserStopIntercepting: vi.fn(asyncNoop),
  handleBrowserEmulateDevice: vi.fn(asyncNoop),
  handleBrowserSetGeolocation: vi.fn(asyncNoop),
  handleBrowserSetMediaFeatures: vi.fn(asyncNoop),
  handleBrowserEmulateVisionDeficiency: vi.fn(asyncNoop),
  handleBrowserClearEmulation: vi.fn(asyncNoop),
  handleBrowserGetElementStyles: vi.fn(asyncNoop),
  handleBrowserForcePseudoState: vi.fn(asyncNoop),
  handleBrowserGetCssCoverage: vi.fn(asyncNoop),
  handleBrowserThrottleNetwork: vi.fn(asyncNoop),
  handleBrowserClearNetworkThrottle: vi.fn(asyncNoop),
