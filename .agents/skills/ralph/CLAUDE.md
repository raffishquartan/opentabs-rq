...
- **`__SKILL__.md`**: Contains the full skill instructions — the ralph task planner workflow, PRD format, story rules, etc. This is the file to edit when updating the skill.

## Updating the Skill

When you need to update the ralph skill content:
