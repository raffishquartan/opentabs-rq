...
function fetchJSON<T>(url: string, init?: FetchFromPageOptions): Promise<T>;
...
```typescript
// Unchecked cast (backward compatible)
function postJSON<T>(url: string, body: unknown, init?: FetchFromPageOptions): Promise<T>;
...
```typescript
// Unchecked cast (backward compatible)
function postForm<T>(url: string, body: Record<string, string>, init?: FetchFromPageOptions): Promise<T>;
...
```typescript
// Unchecked cast (backward compatible)
function postFormData<T>(url: string, body: FormData, init?: FetchFromPageOptions): Promise<T>;
...
```typescript
function putJSON<T>(url: string, body: unknown, init?: FetchFromPageOptions): Promise<T>;
...
```typescript
function patchJSON<T>(url: string, body: unknown, init?: FetchFromPageOptions): Promise<T>;
